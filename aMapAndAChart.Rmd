...
localdata$date<-as.Date(localdata$Date.Found, format='%m/%d/%Y')
localdata$date[is.na(localdata$date)] <- as.Date(localdata$Start.date[is.na(localdata$date)], format='%m/%d/%Y')
```
